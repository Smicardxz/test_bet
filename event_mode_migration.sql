-- EVENT MODE MIGRATION SQL
-- Exécuter cette requête dans Supabase SQL Editor ou PostgreSQL
...
is_event_match = CASE 
    ...
    WHEN LOWER(competition_name) LIKE '%copa america%' OR LOWER(competition_name) LIKE '%afcon%' OR LOWER(competition_name) LIKE '%asian cup%' OR LOWER(competition_name) LIKE '%gold cup%' OR LOWER(competition_name) LIKE '%nations league%' THEN TRUE
    WHEN LOWER(competition_name) LIKE '%u20%' OR LOWER(competition_name) LIKE '%u21%' OR LOWER(competition_name) LIKE '%u19%' OR LOWER(competition_name) LIKE '%u17%' OR LOWER(competition_name) LIKE '%under-20%' OR LOWER(competition_name) LIKE '%under-21%' OR LOWER(competition_name) LIKE '%under-19%' OR LOWER(competition_name) LIKE '%under-17%' OR LOWER(competition_name) LIKE '%youth%' OR LOWER(competition_name) LIKE '%junior%' THEN TRUE
...
event_name = CASE 
    ...
    WHEN LOWER(competition_name) LIKE '%u20%' OR LOWER(competition_name) LIKE '%u21%' OR LOWER(competition_name) LIKE '%u19%' OR LOWER(competition_name) LIKE '%u17%' OR LOWER(competition_name) LIKE '%under-20%' OR LOWER(competition_name) LIKE '%under-21%' OR LOWER(competition_name) LIKE '%under-19%' OR LOWER(competition_name) LIKE '%under-17%' OR LOWER(competition_name) LIKE '%youth%' OR LOWER(competition_name) LIKE '%junior%' THEN competition_name
